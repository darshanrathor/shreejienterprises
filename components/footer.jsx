...
<span className=''>Email : shreejienterprises452011@gmail.com</span>
          ...
          <div class="grid grid-cols-3 gap-4 sm:gap-6 sm:w-full sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase d">Useful Link</h2>
                  <ul class="text-gray-500 center justify-center items-center dark:text-gray-400 font-medium">
                      <li className=" mb-2">
