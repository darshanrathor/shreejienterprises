...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="mb-32">
    <div class="flex flex-wrap justify-between ">
      <div class="mb-10 w-full max-w-[300px] ml-0  shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
        ...
        <form>
          ...
          <div class="relative mb-6" data-te-input-wrapper-init>
            ...
            <label
              ...
              leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
          ...
          <div class="relative mb-6" data-te-input-wrapper-init>
            ...
            <label for="exampleFormControlTextarea1"
              class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%]
               ...
               dark:text-neutral-200 dark:peer-focus:text-primary">Message</label>
          </div>
